...
const CreatePost = ({ isEdit }) => {
  ...
  // Hàm để reset ảnh đã chọn
  const resetImages = () => {
    setImagesPreview([]); // Đặt giá trị của imagesPreview về mảng rỗng
    setPayload((prev) => ({
      ...prev,
      images: "", // Đặt giá trị của images trong payload về chuỗi rỗng
    }));
  };
  return (
    <div className="px-6">
      ...
      <div className="flex gap-4">
        ...
        <div className="w-[30%] flex-none gap-8 py-4">
          <div className="bg-orange-100 text-orange-900 rounded-md">
